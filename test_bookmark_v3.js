...
function stringToHex(str) {
    ...
    const utf16Str = bom + str;
    const buf = Buffer.from(utf16Str, 'utf16be');
...
async function test() {
    ...
    for (let i = 0; i < pageCount; i++) {
        ...
        console.log(`创建书签: 第 ${i + 1} 页, hex: ${titleHex.substring(0, 20)}...`);
    }
    ...
    fs.writeFileSync('./test_output_v3.pdf', pdfBytes);
    console.log('测试PDF已保存: test_output_v3.pdf');
}
